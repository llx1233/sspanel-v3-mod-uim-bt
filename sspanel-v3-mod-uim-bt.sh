...
wget -N --no-check-certificate "https://github.com/llx1233/ss-panel-v3-mod_Uim-alipay-wxpay/archive/dev.zip"
unzip dev.zip
cd ss-panel-v3-mod_Uim-alipay-wxpay-dev
mv * .[^.]* /www/wwwroot/$website/
cd ..
rm -rf ss-panel-v3-mod_Uim-alipay-wxpay-dev/
...
echo -e "${Info} github地址:https://github.com/llx1233/sspanel-v3-mod-uim-bt"
echo -e "${Info} 博客地址:https://www.xmfanguo.com/"
echo "--------------------------------------------------------------------------------"
